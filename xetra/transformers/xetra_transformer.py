...
class XetraSourceConfig(NamedTuple):
    """
    class for source configuation data
    ...
    srr_col_max_price: str
    src_col_traded_volumn: str
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_op_price: column_name for opening price in target
    ...
    trg_col_dail_trad_vol: column name for daily traded volumen in target
    ...
    trg_format: file fomrat of the target file
    """
...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: S3BucketConnector,
        ...
        """
        Constrcutor for XetraTransformer

        :param s3_bucket_src: conneciton to source S3 bucket
        :param s3_bucket_trg: connection to target s3 bucket
        :param meta_key: used as self.meta_key -> key of metal file
        :param src_args: NamedTuple class with source confguration data
        :param trg_args: NameTuple class with target configuration data
        """
